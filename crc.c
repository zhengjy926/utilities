...
/**
 * @brief CRC table for the CRC-16. The poly is 0x1021 (x^16 + x^12 + x^5 + 1),
 *        input data reversed : false,
 *        output data reversed : false.
 */
static uint16_t const crc16_1021_table[256] = {
...
/**
  * @brief  compute the CRC-16 which poly is 0x8005 (x^16 + x^15 + x^2 + 1)
  *         for the data buffer
  * @param  initial_value: The initialization preset value of crc
  * @param  xor_out_value: The final CRC value is XOR with this parameter.
...
/**
  * @brief  compute the CRC-16 which poly is 0x1021 (x^16 + x^12 + x^5 + 1)
  *         for the data buffer
  * @param  initial_value: The initialization preset value of crc
  * @param  xor_out_value: The final CRC value is XOR with this parameter.
  * @param  buffer       : data pointer
